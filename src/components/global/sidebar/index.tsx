...
const Sidebar = ({ activeWorkspaceId }: Props) => {
  ...
  //  // Extracted function to render workspace items
  //  const renderWorkspaceItems = () => {
  //   return workspace.workspace.map((item) => (
  //     item.type !== 'PERSONAL' && (
  //       <SidebarItem
  ...
  // // Extracted function to render member workspaces
  // const renderMemberWorkspaces = () => {
  //   return workspace.members.map((item) => (
  //     <SidebarItem
