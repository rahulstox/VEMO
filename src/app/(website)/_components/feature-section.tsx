...
export function FeatureSection() {
  const data = [
    {
      key: "Create Workspaces", // ADDED
      title: "Create Workspaces",
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-4">
            Organize your projects efficiently with dedicated workspaces. Invite
            team members, manage permissions, and keep your video content
            structured.
          </p>
          <div className="flex justify-center">
            <Image
              src="/Organiize & Share.png"
              alt="Vemo workspace interface"
              width={800}
              height={450}
    ...
    {
      key: "Record & Upload Videos", // ADDED
      ...
      content: (
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <Image
              src="/personal workspace.png"
              alt="Vemo video organization interface"
              width={600}
              height={338}
            ...
            />
            <Image
              src="/sharing options.png"
              alt="Vemo video sharing options"
              width={600}
              height={338}
              className="rounded-lg object-cover w-full h-auto shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]"
            />
    ...
    {
      key: "Collaborate & Feedback", // ADDED
      ...
      content: (
        <div>
          ...
          <div className="flex justify-center">
            <Image
              src="/invite-user.webp"
              alt="Vemo collaboration features"
              width={800}
              height={450}
              className="rounded-lg object-cover w-full max-w-2xl h-auto shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]"
            />
